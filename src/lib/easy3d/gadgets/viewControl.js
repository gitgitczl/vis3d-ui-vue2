...
let viewControl = {
    ...
    activate(viewer, opt) {
        ...
        // 默认给个初始视角
        this.viewOpt.initView = this.viewOpt.initView || cUtil.getCameraView(this.viewer);
    ...
    cameraMoveEndHandler() {
        ...
        let cameraV = cUtil.getCameraView(this.viewer);
    ...
    flyTo(view) {
        ...
        cUtil.setCameraView(view,this.viewer);
    }
}
