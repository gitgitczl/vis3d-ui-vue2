 ...
 * @param {Object} opt 
 * @param {Cesium.Cartesian3} opt.position  位置
 * @param {String} opt.image  图片路径
 * @param {Number} opt.allTime  生命周期
 * @param {Array} opt.burstTimes  爆炸时间点
 * @param {Number} opt.burstScale  爆炸缩放
 */
let ParticleSystem = function (viewer, opt) {
    this.viewer = viewer;
    this.opt = opt || {};
