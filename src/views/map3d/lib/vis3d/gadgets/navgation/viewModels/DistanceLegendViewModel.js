...
DistanceLegendViewModel.prototype.show = function (container) {
  ...
  if (this.enableDistanceLegend) {
    testing = '<div class="distance-legend" id="vis3d-distance-legend" data-bind="visible: distanceLabel && barWidth">' +
    ...
    testing = '<div class="distance-legend" id="vis3d-distance-legend" style="display: none;" data-bind="visible: distanceLabel && barWidth">' +
      '<div class="distance-legend-label"  data-bind="text: distanceLabel"></div>' +
...
DistanceLegendViewModel.prototype.setStyle = function (style) {
  ...
  let ele = document.getElementById("vis3d-distance-legend");
  if(!ele) return ;
  for(let i in style){
    ele.style[i] = style[i];
  }
